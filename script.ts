...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!quiz || !result || !emailForm) return;
        ...
        if (target.classList.contains('option')) {
            ...
            setTimeout(() => {
                if (currentQuestion < quizQuestions.length) {
                    ...
                    const currentQuestionElement = document.querySelector(`.quiz-question[data-question="${currentQuestion}"]`) as HTMLElement;
                    ...
                    // Show next question
                    currentQuestion++;
                    const nextQuestionElement = document.querySelector(`.quiz-question[data-question="${currentQuestion}"]`) as HTMLElement;
                    if (nextQuestionElement) {
                        nextQuestionElement.style.display = 'block';
                    }
                } else {
                    // Show results
                    (quiz as HTMLElement).style.display = 'none';
    ...
    emailForm.addEventListener('submit', function(e) {
        ...
        const requiredConsent = document.getElementById('consent-required') as HTMLInputElement;
        const marketingConsent = document.getElementById('consent-marketing') as HTMLInputElement;
        const thirdPartyConsent = document.getElementById('consent-thirdparty') as HTMLInputElement;
        
        if (!emailInput || !requiredConsent) return;
